...
const CategorySection = () => {
  ...
  return (
    <section className={`py-10 lg:py-10 px-4 transition-colors duration-300 ${
      isDarkTheme ? 'bg-[#16171E] text-white border-t border-b border-gray-800' : 'bg-[#F9FAFB] text-gray-900 border-b border-gray-200'
    }`}>
