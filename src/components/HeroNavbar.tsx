        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
              <motion.button 
                className={`font-medium flex items-center ${!isContentVisible ? 'text-white hover:text-white/80' : (isDarkTheme ? 'text-white hover:text-white/80' : 'text-gray-900 hover:text-primary')}`}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                Categories
                <motion.svg 
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            >
              <input
                ...
                className={`backdrop-blur-md border border-gray-200/50 rounded-full py-2 pl-4 pr-10 w-64 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary/50 transition-all duration-300 ${
                  isContentVisible 
                  ? (isDarkTheme ? 'text-white placeholder-gray-400 border-gray-600/50 focus:border-gray-500/50 bg-gray-800/30' : 'text-white placeholder-gray-400 border-gray-600/50 focus:border-gray-500/50 bg-gray-100/30')
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
              <Link to="/cart" className={`${!isContentVisible ? 'text-white/70 hover:text-white' : (isDarkTheme ? 'text-white/70 hover:text-white' : 'text-gray-700 hover:text-primary')} relative`}>
          ...
          <div className="md:hidden flex items-center space-x-5">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
              <Link to="/cart" className={`${isDarkTheme ? 'text-white/80 hover:text-white' : 'text-gray-700 hover:text-primary'} relative`}>
              ...
              >
                {[
                  ...
                  >
                    <Link 
                      to={item.path} 
                      className={`font-medium block relative ${isActive(item.path) ? 'text-primary' : isDarkTheme ? 'text-white' : 'text-gray-900'}`} 
                      onClick={toggleMenu}
                    >
                      {item.label}
                      {isActive(item.path) && (
                ...
                <motion.div 
                  ...
                  className="pt-8 relative top-2 border-t border-gray-300 dark:border-gray-700"
                >
                        ...
                        <input
                          ...
                          className={`backdrop-blur-md border border-gray-200/50 rounded-full py-3 pl-4 pr-12 w-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary/50 transition-all duration-300 ${
                            isDarkTheme 
                                ...
                                : 'text-gray-900 placeholder-gray-500 bg-gray-500/5'
                          }`}
                          value={searchQuery}
                          onChange={(e) => setSearchQuery(e.target.value)}
                        />
